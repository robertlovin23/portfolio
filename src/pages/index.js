...
const IndexPage = () => {
  return(
    <div>
      <Header/>
        <div className="flex mb-4 background-video">
              ...
              <source src={sunset} type="video/mp4" />
                  ...
                  <div className="w-1/2 h-12">
                    ...
                    <div className="titleArea">
                      ...
                      <div className="w-1/2 desc-text">
                        <p>I design dependable and cost-effective technological solutions for people who want to focus on refining their business.</p>
                      </div>
                      <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow btn">
                        More About Me
                      </button>
                    </div>
                </div>
        ...
        <div className="section">
                <div>
                  <h3 className="title" style={{ marginBottom:"50px", textAlign:'center'}}>Technologies I have worked with</h3>
                </div>
                <div className="techSection">
                     <div className="flex mb-4">
                       ...
                       <div className="w-1/4 h-12">
                         <img src={MongoDB}  style={{width:"80%", marginLeft:"auto",marginRight:"auto"}}/>
                       </div>
                       <div className="w-1/4 h-12">
                ...
                <div className="techSection" style={{marginTop:"100px"}}>
                     <div className="flex mb-4">
                       <div className="w-1/4 h-12">
                        <svg viewBox="0 0 128 128" className="logo">
